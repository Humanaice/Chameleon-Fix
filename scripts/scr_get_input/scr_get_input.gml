...
function scr_get_input() 
{
	...
	/// @DnDHash : 5494C81E
	/// @DnDParent : 624B9495
	/// @DnDArgument : "code" "//Keyboard input$(13_10)$(13_10)upkey = keyboard_check(ord("W"));$(13_10)leftkey = keyboard_check(ord("A"));$(13_10)downkey = keyboard_check(ord("S"));$(13_10)rightkey = keyboard_check(ord("D"));$(13_10)dashkey = keyboard_check_pressed(ord("J"));$(13_10)firekey =  keyboard_check(ord("H"));$(13_10)if (dashkey) $(13_10){$(13_10)	dash = true$(13_10)}$(13_10)if (firekey) $(13_10){$(13_10)	playerfire = true$(13_10)}"
	//Keyboard input
