...
var _upgrades = [o_upgrade_general,o_upgrade_get_shield,o_upgrade_health]

if (_item <= 40)
{
	var _inst_item = instance_create_layer(x,y,"Layer_upgrade",_upgrades[irandom(2)])
