...
if (room == rm_level_1)
{
	...
	if (global.clock >= 30) 
	{
		...
		if (enemy_kamikaze_clock >= 320 and enemys_to_create > 0) 
			{
				instance_create_layer(irandom_range(50,room_width - 50),0,"Layer_enemy",o_enemy_raylaser_stop);
