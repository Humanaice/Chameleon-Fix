...
/// @DnDVersion : 1
/// @DnDHash : 27390B90
/// @DnDArgument : "code" "clock_initial = 0$(13_10)global.clock = 0$(13_10)enemy_kamikaze_clock = 0$(13_10)enemys_to_create = 100;$(13_10)$(13_10)enemy_list = [o_enemy_kamikaze,o_enemy_raylaser_stop,o_enemy_simple_down]"
clock_initial = 0
global.clock = 0
enemy_kamikaze_clock = 0
enemys_to_create = 100;

enemy_list = [o_enemy_kamikaze,o_enemy_raylaser_stop,o_enemy_simple_down]
